...
set DEFAULT_JVM_OPTS= -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005 "-XX:MaxMetaspaceSize=256m" "-XX:+UseParallelGC" "-XX:SurvivorRatio=6" "-XX:-UseGCOverheadLimit"
